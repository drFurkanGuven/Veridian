...
from veridian_api.presentation.rest.v1.ai.router import router as ai_router
...
from veridian_api.presentation.rest.v1.projects.ai_router import router as project_ai_router
...
from veridian_api.presentation.ws.ai_router import router as ws_ai_router
...
api_v1_router.include_router(ws_ai_router, tags=["websockets"])
